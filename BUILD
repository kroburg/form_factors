...
CUDA libraries has dependency on nVidia CUDA Samples. It is header only dependency on common includes (NVIDIA_CUDA-7.5_Samples/common/inc).

For Windows there are Visual Studio 2013 projects and solution provided.
It may be required to alter Additional includes and libraries paths.
VS project configured to use CUDA 7.5 environment variables.
